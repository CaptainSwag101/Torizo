...
private:
    ...
    constexpr static int TILE_GRAPHICS_SIZE = 16 * 16 * 0x20;
    //constexpr static int DECOMPRESSED_PALETTE_DATA_SIZE = 16 * 16 * sizeof(ushort);
    constexpr static int DECOMPRESSED_PALETTE_DATA_SIZE = 0x20;
};
